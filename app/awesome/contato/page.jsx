...
export default function AwesomeContato() {
  ...
  useEffect(() => {
    ...
    return () => email.removeEventListener("focus", onEmailFocus);
  }, []);
  ...
  return (
    <div className={styles.root}>
      <div id="container">
        ...
        <div className="barra-gradiente" style={{ marginTop: "110px" }} />

        <Link className="btn-voltar" href="/awesome">
        ...
        {showObrigado && (
          ...
          >
            <div className="popup-content">
              <p>
                Obrigado amigo, você é um amigo! <i className="fa-solid fa-thumbs-up" />
              </p>
              <button
                className="btn-popup"
        ...
        {showAlerta && (
          ...
          >
            <div className="popup-content">
              <h3>Sério? Formulário?</h3>
              <p>
                Você realmente quer preencher um formulário em 2025? Às vezes um
                zap funciona melhor, mas se prefere, siga em frente...
              </p>
              <button
